...
?>
        ...
        <div id="slider_wrapper" style="margin: 0 auto 0; width: 1200px; position: relative;">
            <div id="sliderb_container" style="position: relative; width: 1200px; height: 450px; overflow: hidden;">
                ...
                <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1200px; height: 450px;
                    overflow: hidden;">
                    <div>
                        <img u=image src="images/slider/01.jpg" />
                        <div u="thumb">Try our *NEW* 45-minute Resistance Training Classes: SWEAT &amp; CORE!</div>
                    </div>
                    <div>
                        <img u=image src="images/slider/02.jpg" />
                        <div u="thumb"></div>
                    </div>
                </div>

                <!-- ThumbnailNavigator Skin Begin -->
                <div u="thumbnavigator" class="sliderb-T" style="position: absolute; bottom: 0px; left: 0px; height:45px; width:1200px;">
                    ...
                    <div u="slides">
                        <div u="prototype" style="POSITION: absolute; WIDTH: 1200px; HEIGHT: 45px; TOP: 0; LEFT: 0;">
